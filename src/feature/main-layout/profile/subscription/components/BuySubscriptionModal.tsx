...
const BuySubscriptionModal = async ({ open, setOpen }: { open: boolean, setOpen: (open: boolean) => void }) => {
    const [allSubscriptions, setAllSubscriptions] = React.useState<SubscriptionPackage[]>([]); 
