...
export const aboutUsContent: PolicyContent = {
  ...
  content: `
    <p class="text-base md:text-lg  leading-relaxed">
      <strong class="">263 prolink</strong> is a trusted multi-service platform dedicated to delivering high-quality domestic, professional, and property services under one roof. We connect customers with skilled, verified professionals who are committed to excellence, reliability, and customer satisfaction.
    </p>

    <p class="mt-4  leading-relaxed">
      Our mission is simple — to make everyday services easier, faster, and more dependable. Whether you need help at home, on your property, or at a worksite, 263 prolink ensures you get the right expert for the job, every time.
    </p>
    ...
    <p class="mt-6  leading-relaxed">
      At 263 prolink, we believe that great service is built on trust, professionalism, and attention to detail. Every service provider on our platform is carefully selected to ensure they meet our quality benchmarks and deliver consistent results.
    </p>

    <p class="mt-6  leading-relaxed">
      Whether it’s maintaining your home, improving your property, or completing a professional project,
      <strong class="">263 prolink</strong> is here to help you get it done — efficiently and professionally.
    </p>
