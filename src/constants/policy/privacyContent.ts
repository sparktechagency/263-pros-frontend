...
export const privacyPolicyContent: PolicyContent = {
  ...
  content: `
    <p class="text-base md:text-lg leading-relaxed">
      At <strong>263 prolink</strong>, your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your personal information when you use our platform.
    </p>
    ...
    <p class="mt-3 leading-relaxed">
      263 prolink may use cookies and similar technologies to enhance user experience and analyze platform usage.
    </p>
